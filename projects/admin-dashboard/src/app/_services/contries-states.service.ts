...
export class CountriesStates {
    ...
    getCountries() {
        ...
        this.countriesStates.forEach((data) => {
    ...
    getStates(countryName) {
        let i = 0;
        for(i = 0; i < this.countriesStates.length; i++) {
            if (this.countriesStates[i].name == countryName) {
                return this.countriesStates[i].states;
            }
        }
    }
